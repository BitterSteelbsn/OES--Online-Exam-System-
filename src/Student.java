		...
		mntmNewMenuItem_3.addActionListener(new ActionListener() {
			...
			try {
					...
					JTableHeader tableheader = table.getTableHeader();
					 ...
					 P.getColumn(0).setPreferredWidth(500);
					 
					 P.getColumn(1).setHeaderValue("TITLE");
					 P.getColumn(1).setPreferredWidth(500);
					 
					 P.getColumn(2).setHeaderValue("FACULTY");
					 P.getColumn(2).setPreferredWidth(500);
		...
		table.addMouseListener(new MouseAdapter() {
					...
					public void mouseClicked(MouseEvent e) {
				        ...
				        if (row >= 0 && col >= 0) {
							...
							new ExamStartPage(clickedExamId, (String)table.getValueAt(row, 1), (String)table.getValueAt(row, 2), student_id, username, password).setVisible(true);
						}
